...
speedUp = pygame.mixer.music.load('C:/Users/chetl/PycharmProjects/SuperMarioPython/data/sounds/fastTheme.mp3')

gameOverSound = pygame.mixer.Sound('data\sounds\gameover.wav')
pygame.mixer.music.load(r'C:\Users\chetl\PycharmProjects\SuperMarioPython\data\sounds\maintheme.ogg')
musicPlaying = True
...
while True:
    ...
    if levelTimer <= 100 and not lowTime:
        lowTime = True
        pygame.mixer.music.load('C:/Users/chetl/PycharmProjects/SuperMarioPython/data/sounds/fastTheme.mp3')
        pygame.mixer.music.play(-1, 0.0)
        speedUp.play()
